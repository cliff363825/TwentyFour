// https://locutus.io/php/strings/levenshtein/index.html
...
console.log(levenshtein('carrrot', 'apple'))
console.log(levenshtein('carrrot1', 'carrots', 2, 3, 4))
console.log(levenshtein('carrots', 'carrrot1', 2, 3, 4))
