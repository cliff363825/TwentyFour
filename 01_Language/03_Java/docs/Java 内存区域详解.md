# [Java 内存区域详解](https://gitee.com/SnailClimb/JavaGuide/blob/master/docs/java/jvm/Java内存区域.md)
...
![JVM堆内存结构-JDK7](./images/JVM堆内存结构-JDK7.png)

JDK 8 版本之后方法区（HotSpot 的永久代）被彻底移除了（JDK1.7 就已经开始了），取而代之是元空间，元空间使用的是直接内存。

![JVM堆内存结构-JDK8](./images/JVM堆内存结构-jdk8.png)
...
下图便是 Java 对象的创建过程，我建议最好是能默写出来，并且要掌握每一步在做什么。 ![Java创建对象的过程](./images/Java创建对象的过程.png)
...
![String-Pool-Java](./images/2019-3String-Pool-Java1-450x249.png)
