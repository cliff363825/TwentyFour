...
1. Spring Boot 入门
    ...
    3. 环境准备
        ...
        3. 统一环境；
            ...
            2. IDEA设置
                1. 整合maven进来；
                    1. ![idea设置](images/搜狗截图20180129151045.png)
                    2. ![images/](images/搜狗截图20180129151112.png)
        ...
        2. 主程序类，主入口类
            ...
            7. @Import(EnableAutoConfigurationImportSelector.class)；
                ...
                2. EnableAutoConfigurationImportSelector：导入哪些组件的选择器；
                    ...
                    3. ![自动配置类](images/搜狗截图20180129224104.png)
...
2. 配置文件
    ...
    3. 配置文件值注入
        ...
        4. properties配置文件在idea中默认utf-8可能会乱码
            1. 调整
                1. ![idea配置乱码](images/搜狗截图20180130161620.png)
    ...
    3. SLF4j使用
        1. 如何在系统中使用[SLF4j](https://www.slf4j.org)
            ...
            2. 给系统里面导入slf4j的jar和  logback的实现jar
                ...
                ```
            3. 图示；
                1. ![images/concrete-bindings.png](images/concrete-bindings.png)
...
4. Web开发
    ...
    2. SpringBoot对静态资源的映射规则；
        ...
        1. 所有 /webjars/** ，都去 classpath:/META-INF/resources/webjars/ 找资源；
            1. webjars：以jar包的方式引入静态资源；
                ...
                2. ![](images/搜狗截图20180203181751.png)
            ...
            2. 使用：
                ...
                3. 语法规则
                    1. th:text；改变当前元素里面的文本内容；
                        ...
                        2. ![](images/2018-02-04_123955.png)
                    2. 表达式？
                        ```
    ...
    7. 错误处理机制
        1. SpringBoot默认的错误处理机制
            1. 默认效果：
                1. 浏览器，返回一个默认的错误页面
                    1. ![](images/搜狗截图20180226173408.png)
                2. 浏览器发送请求的请求头：
                    1. ![](images/搜狗截图20180226180347.png)
                3. 如果是其他客户端，默认响应一个json数据
                    1. ![](images/搜狗截图20180226173527.png)
                    2. ![](images/搜狗截图20180226180504.png)
            2. 原理：
        ...
        2. 如果定制错误响应：
            ...
            2. 如何定制错误的json数据；
                ...
                5. 最终的效果：响应是自适应的，可以通过定制ErrorAttributes改变需要返回的内容，
                    1. ![](images/搜狗截图20180228135513.png)
    8. 配置嵌入式Servlet容器
        1. SpringBoot默认使用Tomcat作为嵌入式的Servlet容器；
            1. ![](images/搜狗截图20180301142915.png)
            2. 问题？
        ...
        3. 替换为其他嵌入式Servlet容器
            1. ![](images/搜狗截图20180302114401.png)
            2. 默认支持：
                1. Tomcat（默认使用）
                    ```
                    <dependency>
        ...
        4. 嵌入式Servlet容器自动配置原理；
            1. EmbeddedServletContainerAutoConfiguration：嵌入式的Servlet容器自动配置？
                ...
                1. EmbeddedServletContainerFactory（嵌入式Servlet容器工厂）
                    ...
                    ```
                    1. ![](images/搜狗截图20180302144835.png)
                2. EmbeddedServletContainer：（嵌入式的Servlet容器）
                    1. ![](images/搜狗截图20180302144910.png)
...
5. Docker
    ...
    2. 核心概念
        ...
        6. ![](images/搜狗截图20180303165113.png)
    3. 使用Docker的步骤：
        1. 安装Docker
...
6. SpringBoot与数据访问
    ...
    3. 整合MyBatis
        ...
        ```
        1. ![](images/搜狗截图20180305194443.png)
        2. 步骤：
    ...
    4. 整合SpringData JPA
        1. SpringData简介
            1. ![](images/搜狗截图20180306105412.png)
        2. 整合SpringData JPA
    ...
    1. 几个重要的事件回调机制
        ...
        3. 启动流程：
            1. 创建SpringApplication对象
                ...
                ```
                1. ![](images/搜狗截图20180306145727.png)
                2. ![](images/搜狗截图20180306145855.png)
            2. 运行run方法
                ```
                public ConfigurableApplicationContext run(String... args) {
                   StopWatch stopWatch = new StopWatch();
