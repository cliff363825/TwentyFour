package com.onevgo.bookstore.servlet;
...
import com.onevgo.bookstore.service.AccountService;
import com.onevgo.bookstore.service.BookService;
import com.onevgo.bookstore.service.UserService;
import com.onevgo.bookstore.web.BookStoreWebUtils;
import com.onevgo.bookstore.web.CriteriaBook;
import com.onevgo.context.GsonContext;
...
public class BookServlet extends HttpServlet {
    ...
    protected void updateItemQuantity(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String jsonStr = GsonContext.getInstance().getGson().toJson(result);
